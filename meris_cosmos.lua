...
function redraw()
  ...
  if morph_active then
    screen.level(15)
    screen.move(0, 58)
    screen.text(\"MORPHING...\")
  elseif morph_capture_pending then
    screen.level(12)
    screen.move(0, 58)
    screen.text(\"Capture: press K3 again\")
  else
    screen.level(3) screen.move(0,58)
    screen.text(\"E1:pdl E2:pst K2:snd K1+K3:morph E3:rnd\")
  end

  if auto_morph then
    screen.level(15) screen.move(118,50) screen.text(\"~\")
  end
